...
/**
 * La siguiente interfaz representa el TDA Fracción. Su objetivo es definir a
 * una fracción en términos de las operaciones que soporta y no de la
 * implementación de dichas operaciones. Algunas reglas que deben cumplir las
 * operaciones se mencionan en los comentarios.
 *
...
public interface Fraction {
     ...
     *
     * @return La representación estandar más simplificada de la fracción
     * actual. eg. si la fracción actual es 2/3=4/6=... se debe imprimir "2/3"
     */
    @Override
